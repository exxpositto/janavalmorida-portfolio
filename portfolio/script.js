...
filterBtns.forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        showcaseItems.forEach(item => {
            ...
            const isFun = item.classList.contains('fun-projects-grid');
...
function setupLightbox() {
    ...
    // Fun projects (tiles only)
    document.querySelectorAll('.fun-tile').forEach(tile => {
        const img = tile.querySelector('img');
        const title = "Experimental Piece";
        const desc = "A personal exploration into digital forms and lighting.";
